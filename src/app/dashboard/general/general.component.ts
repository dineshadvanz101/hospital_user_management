...
export class GeneralComponent implements OnInit {
  ...
  createForm(id) {
    ...
    vim.generalForm = vim.formBuilder.group({
      ...
      baby_condition_lga_suspect: ["", Validators.required],
      baby_condition_aga_suspect: ["", Validators.required],
      baby_condition_sga_suspect: ["", Validators.required],
  ...
  updateForm(obj) {
    ...
    vim.generalForm.patchValue({
      ...
      baby_condition_lga_suspect: obj["baby_condition_lga_suspect"],
      baby_condition_aga_suspect: obj["baby_condition_aga_suspect"],
      baby_condition_sga_suspect: obj["baby_condition_sga_suspect"],
  ...
  updateGeneralForm(){
    ...
    vim.generalForm.value["isCreateForm"] = vim.isBabyCreateGeneral;
        ...
        this.common_api.updateBabyProfile(this.studyId,this.generalForm['value']).subscribe(result=>{
